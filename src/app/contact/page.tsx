...
export default function Contact() {
  ...
  const copyEmail = () => {
    navigator.clipboard.writeText('georgema2020@gmail.com');
    setEmailCopied(true);
      ...
      <div className="flex min-h-screen w-full items-center justify-center pt-44 align-middle text-[8.6vw] xs:text-[5.6vw]">
        <div className="p-12 xs:w-1/2 xs:p-0">
          <div className="flex justify-between uppercase">
            <p className="m-0">George</p>
            <p className="m-0">Ma</p>
          </div>
          <div className="flex justify-between uppercase">
          ...
          <div className="flex justify-between uppercase">
            ...
            <Link href={'https://www.linkedin.com/in/ggeorgema'}>
          ...
          <div className="flex justify-between uppercase">
            ...
            <Link href={'https://github.com/itsgeorgema'}>
              <TextDisperse setBackground={setBackground}>
                <p>→Github</p>
              </TextDisperse>
            </Link>
